...
def on_mib(mibname, mib, mib_index, lk_definitions):
    lk = {
        0: (0, ),
        1: (1, ),
        2: (2, ),
    ...
    for imibname, iobjs in mib_imports:
        ...
        m_lk, m_lk_definitions = mib_index[imibname]
        for iobj in iobjs:
            if iobj in smi_objs:
                pass
            elif iobj in lk:
                ...
                lk[iobj] = m_lk[iobj]
            elif iobj in m_lk_definitions:
                lk_definitions[iobj] = m_lk_definitions[iobj]
            else:
    ...
    mib_index[mibname] = lk, lk_definitions
